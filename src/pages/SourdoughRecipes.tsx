...
const SourdoughRecipes: React.FC = () => {
  const recipes = [
    ...
    },
    {
      ...
      description: "delicious sourdough pancake recipe that incorporates the tangy flavor of sourdough.",
      ingredients: [
        "1 cup bread flour",
        ...
        "1 cup of water mixed with 1 1/2 tablespoons of vinegar",
        "2 tablespoon butter, melted",
        "1/2 teaspoon salt",
        "Optional: 1 teaspoon cinnamon and/or vanilla extract"
      ],
      instructions: "Combine flours and water, add starter and salt, eggs, etc. ferment for up to 30 minutes, cook as usual."
    },
    {
      id: 3,
